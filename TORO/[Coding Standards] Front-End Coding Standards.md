[Coding Standards CSS] Front-End Developer
======================================

Coding standards included here are heavily inspired from the following resources.

* Resources
 * [Necolas Idiomatic CSS](https://github.com/necolas/idiomatic-css) <--- **READ THIS FOLLOW THIS**
 * [Mdo Code Guide](http://mdo.github.io/code-guide/) <--- **READ THIS FOLLOW THIS**
